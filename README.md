# Tech Store - Eletrônicos Premium
...
- **Flex Layout**: Utilização de `display: flex` para alinhamento de elementos

### Componentes Bootstrap

1. **Navbar**: Barra de navegação responsiva com `navbar-collapse` para mobile
2. **Buttons**: Botões estilizados com classes `.btn` e efeitos de hover
3. **Cards**: Estrutura básica de cards para apresentação de produtos
4. **Bootstrap Icons**: Ícones (`bi bi-bag-plus`) para melhor visual dos elementos
5. **Responsividade**: Media queries e classes responsivas do Bootstrap

### Utilitários e Classes

- **Spacing**: Paddings e margins com classes Bootstrap (`mt-5`, `py-3`, etc)
- **Typography**: Tratamento de textos e fontes
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/gabrielcavallari03-glitch/exE4-BS.git
   ```
